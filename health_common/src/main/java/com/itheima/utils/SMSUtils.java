...
public class SMSUtils {
	...
	public static void sendShortMessage(String templateCode,String phoneNumbers,String param) throws ClientException{
		...
		// 替换成你的AK
		final String accessKeyId = "LTAI4FfQ1pQB91giZHLyL4xo";// 你的accessKeyId,参考本文档步骤2
		final String accessKeySecret = "xCdGRIAjcrLl3p54SXYtRUcupMcbah";// 你的accessKeySecret，参考本文档步骤2
