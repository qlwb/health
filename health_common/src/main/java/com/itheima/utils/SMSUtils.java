...
public class SMSUtils {
    public static final String VALIDATE_CODE = "SMS_169113136";//发送短信验证码
    ...
    public static void sendShortMessage(String phoneNumbers,String param) throws ClientException {
        ...
        final String accessKeyId = "LTAIlgr2GJw31nHB";// 你的accessKeyId,
        final String accessKeySecret = "M9iTKkCMlBdeH8g2IdXQznKgF3s1D4";// 你的accessKeySecret，
        ...
        // 必填:短信签名-可在短信控制台中找到
        request.setSignName("传智健康项目手机号登录");
        // 必填:短信模板-可在短信控制台中找到
    ...
    public static void main(String args[]) throws Exception{
        ...
        SMSUtils.sendShortMessage("18155371278",validateCode);
    }
}
